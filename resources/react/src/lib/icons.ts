...
const registry: Record<string, string> = {
  ...
  'kadoorie:folder-add':
    '<path d="m4.3 12 1.4-2.8c.3-.6.8-.9 1.5-.9h8.7c1 0 1.8.8 1.8 1.8v.8l-1.2 4.8c-.3 1-1 1.5-2 1.5H2.6a1.6 1.6 0 0 1-1.6-1.6V4.8c0-.9.7-1.6 1.6-1.6h4.3c.7 0 1.2.3 1.6.9l.6.9h7.1"/><circle cx="19" cy="17.8" r="3.4" fill="currentColor"/><path d="M17.4 17.8h3.2M19 16.2v3.2" stroke="white"/>',
  'kadoorie:list-xs': '<path d="M15 8H3M17 12H3M13 16H3"/>',
  'kadoorie:shield-xs':
    '<path d="M12 3c2 1.5 3.5 2 5 2v5c0 3-2 5.2-5 6.3C9 15.2 7 13 7 10V5c1.5 0 3-.5 5-2Z"/><path d="m10 10 1.3 1.3L14 8.5"/>',
  'kadoorie:calendar-xs':
    '<rect x="3" y="5" width="18" height="16" rx="2"/><path d="M7 3v4M17 3v4M3 9h18M7 13h.1M11 13h.1M15 13h.1M7 17h.1M11 17h.1M15 17h.1"/>',
