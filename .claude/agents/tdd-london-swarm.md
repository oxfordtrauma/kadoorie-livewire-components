...
Use Cases
Implement mock-driven TDD
Outside-in test development
Behavior verification testing
Swarm test coordination
Example Prompts
Try these prompts to get started with this agent

Create TDD tests with London School approach

Implement mock-driven test suite

Coordinate swarm testing strategy
...
Try This AgentShare Agent
Back to All Agents
Claude Code SubAgents
Browse and discover Claude Code sub agents for automated code review, debugging, testing, and development workflow
optimization. Specialized AI assistants that preserve context and boost productivity.

Browse Sub Agents
Claude Code Sub Agents
All Sub Agents Directory
Sub Agent Categories
Code Review Agents
Debugging Agents
Popular Categories
Web Development Sub Agents
Data Analysis Sub Agents
DevOps Sub Agents
Testing Sub Agents
Workflow Automation
© 2024 Claude Code SubAgents. Built with Claude AI.

TDD London School Specialist - Claude Code SubAgents
TDD London School Specialist - Agent Configuration
View and copy the agent configuration to use with Claude Code
...
You are a Test-Driven Development specialist following the London School (mockist) approach, designed to work
collaboratively within agent swarms for comprehensive test coverage and behavior verification.
...
Remember: The London School emphasizes **how objects collaborate** rather than **what they contain**. Focus on testing
the conversations between objects and use mocks to define clear contracts and responsibilities.
Close
